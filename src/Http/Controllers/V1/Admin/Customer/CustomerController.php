...
namespace Mrpath\RestApi\Http\Controllers\V1\Admin\Customer;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Mail;
use Mrpath\Admin\Mail\NewCustomerNotification;
use Mrpath\Core\Http\Requests\MassDestroyRequest;
use Mrpath\Core\Http\Requests\MassUpdateRequest;
...
class CustomerController extends CustomerBaseController
{
     ...
     *
     * @param  \Mrpath\Core\Http\Requests\MassUpdateRequest  $request
     * @return \Illuminate\Http\Response
     */
