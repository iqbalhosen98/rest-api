...
namespace Mrpath\RestApi\Http\Controllers\V1\Admin;

use Illuminate\Http\Request;
use Mrpath\Core\Http\Requests\MassDestroyRequest;
use Mrpath\RestApi\Contracts\ResourceContract;
use Mrpath\RestApi\Http\Controllers\V1\V1Controller;
use Mrpath\RestApi\Traits\ProvideResource;
use Mrpath\RestApi\Traits\ProvideUser;
...
class ResourceController extends V1Controller implements ResourceContract
{
     ...
     *
     * @param  \Mrpath\Core\Http\Requests\MassDestroyRequest  $request
     * @return \Illuminate\Http\Response
     */
