...
use Mrpath\RestApi\Http\Resources\V1\Shop\Catalog\ProductResource;
...
class ProductController extends CatalogController
{
    ...
    public function additionalInformation(Request $request, $id)
    {
        ...
        $additionalInformation = app(\Mrpath\Product\Helpers\View::class)
    ...
    public function configurableConfig(Request $request, $id)
    {
        ...
        $configurableConfig = app(\Mrpath\Product\Helpers\ConfigurableOption::class)
    ...
    public function isWishlisted(Request $request, $productId)
    {
        ...
        $wishlistHelper = app(\Mrpath\Customer\Helpers\Wishlist::class);
