...
namespace Mrpath\RestApi\Http\Resources\V1\Shop\Catalog;
...
class ProductResource extends JsonResource
{
     ...
     *
     * @var \Mrpath\Product\Helpers\Review
     */
    ...
    {
        $this->productReviewHelper = app(\Mrpath\Product\Helpers\Review::class);
