...
use Mrpath\RestApi\Http\Controllers\V1\Shop\Customer\AddressController;
use Mrpath\RestApi\Http\Controllers\V1\Shop\Customer\AuthController;
use Mrpath\RestApi\Http\Controllers\V1\Shop\Customer\CartController;
use Mrpath\RestApi\Http\Controllers\V1\Shop\Customer\CheckoutController;
use Mrpath\RestApi\Http\Controllers\V1\Shop\Customer\InvoiceController;
use Mrpath\RestApi\Http\Controllers\V1\Shop\Customer\OrderController;
use Mrpath\RestApi\Http\Controllers\V1\Shop\Customer\ShipmentController;
use Mrpath\RestApi\Http\Controllers\V1\Shop\Customer\TransactionController;
use Mrpath\RestApi\Http\Controllers\V1\Shop\Customer\WishlistController;
