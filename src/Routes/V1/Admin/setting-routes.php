...
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\ChannelController;
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\CurrencyController;
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\ExchangeRateController;
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\InventorySourceController;
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\LocaleController;
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\RoleController;
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\SliderController;
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\TaxCategoryController;
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\TaxRateController;
use Mrpath\RestApi\Http\Controllers\V1\Admin\Setting\UserController;
